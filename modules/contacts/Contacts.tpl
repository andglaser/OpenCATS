...
<?php TemplateUtility::printHeader('Kontakte', array('js/highlightrows.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
    ...
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->totalContacts ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    <td width="3%">
                        <img src="images/contact.gif" width="24" height="24" border="0" alt="Kontakte" style="margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Kontakte: Startseite</h2></td>
                    <td align="right">
                            ...
                            <table class="viewSelector">
                                <tr>
                                    ...
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyMyContacts">Nur meine Kontakte</label>&nbsp;
                                    </td>
                                    <td valign="top" align="right" nowrap="nowrap">
                                        ...
                                        <label for="onlyHotContacts">Nur Hot-Kontakte</label>&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </form>
            ...
            <p class="note">
                <span style="float:left;">
                    Kontakte - Seite <?php echo($this->dataGrid->getCurrentPageHTML()); ?>
                    (<?php echo($this->dataGrid->getNumberOfRows()); ?> Einträge)
                    <?php if ($this->dataGrid->getFilterValue('OwnerID') ==  $this->userID): ?>(Nur meine Kontakte)<?php endif; ?>
                    <?php if ($this->dataGrid->getFilterValue('IsHot') == '1'): ?>(Nur Hot-Kontakte)<?php endif; ?>
                </span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    Fügen Sie Kontakte hinzu, um Personen zu verwalten, mit denen Sie zusammenarbeiten.
                    </div>
