        ...
        <div id="contents">
            <table>
                <tr>
                    ...
                    <td><h2>Kandidaten: Bearbeiten</h2></td>
               </tr>
            </table>

            <p class="note">Kandidaten bearbeiten</p>
            ...
            <form name="editCandidateForm" id="editCandidateForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCandidateForm);" autocomplete="off">
                ...
                <table class="editTable" width="700">
                    <tr>
                        <td class="tdVertical" valign="top" style="height: 28px;">
                            <label id="isHotLabel" for="isHot">Aktiv:</label>
                        </td>
                        <td class="tdData" >
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="phoneWorkLabel" for="phoneWork">Telefon dienstlich:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="addressLabel" for="address1">Adresse:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="button" class="button" onclick="CityState_populate('zip', 'ajaxIndicator');" value="Suchen" />
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="canRelocateLabel" for="canRelocate">Beste Zeit für Anruf:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical" valign="top" style="height: 28px;">
                            <label id="isHotLabel" for="isHot">Top-Kandidat:</label>
                        </td>
                        <td class="tdData" >
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="sourceLabel" for="source">Quelle:</label>
                        </td>
                        <td class="tdData">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="ownerLabel" for="owner">Verantwortlich:</label>
                        </td>
                        <td class="tdData">
                            ...
                            <div style="display:none;" id="divOwnershipChange">
                                <input type="checkbox" name="ownershipChange" id="checkboxOwnershipChange" <?php if (!$this->canEmail): ?>disabled<?php endif; ?>> Neuen Verantwortlichen per E-Mail benachrichtigen
                            </div>
                        </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td class="tdData">
                            <input type="button" class="button" id="addImage" name="addImage" value="Profilbild bearbeiten" style="width:150px;" onclick="showPopWin('<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=addEditImage&amp;candidateID=<?php echo($this->candidateID); ?>', 400, 370, null); return false;" />&nbsp;
                        </td>
                    </tr>
                </table>
                ...
                <?php if($this->EEOSettingsRS['enabled'] == 1): ?>
                    <?php if(!$this->EEOSettingsRS['canSeeEEOInfo']): ?>
                        <table class="editTable" width="700">
                            <tr>
                                <td>
                                    Die Bearbeitung von EEO-Daten ist deaktiviert.
                                </td>
                            </tr>
                        </tr>
                ...
                <table class="editTable" width="700">
                    ...
                    <tr>
                        <td class="tdVertical">
                            <label id="keySkillsLabel" for="keySkills">Schlüsselqualifikationen:</label>
                        </td>
                        <td class="tdData">
