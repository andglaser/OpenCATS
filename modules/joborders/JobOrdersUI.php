...
class JobOrdersUI extends UserInterface
{
    ...
    public function __construct()
    {
        ...
        $this->_subTabs = array(
            ...
            'Jobauftrag hinzufügen' => 'javascript:void(0);*js=showPopWin(\''.CATSUtility::getIndexName().'?m=joborders&amp;a=addJobOrderPopup\', 400, 250, null);*al=' . ACCESS_LEVEL_EDIT . '@joborders.add',
            'Jobaufträge suchen' => CATSUtility::getIndexName() . '?m=joborders&amp;a=search'
        );
    }
