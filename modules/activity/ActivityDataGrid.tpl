...
<?php TemplateUtility::printHeader('Aktivitäten', array('js/highlightrows.js', 'js/sweetTitles.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
    ...
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->numActivities ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <table width="100%">
                <tr>
                    <td width="3%">
                        <img src="images/activities.gif" width="24" height="24" alt="Aktivitäten" style="border: none; margin-top: 3px;" />&nbsp;
                    </td>
                    <td><h2>Aktivitäten</h2></td>
                    <td align="right">
            ...
            <p class="note">
                <span style="float:left;">Aktivitäten - Seite <?php echo($this->dataGrid->getCurrentPageHTML()); ?></span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    Aktivitäten werden automatisch basierend auf Ihren Aktionen aufgezeichnet.
                    </div>
                </td>
