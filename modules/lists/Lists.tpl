...
<?php TemplateUtility::printHeader('Listen', array( 'js/highlightrows.js', 'js/sweetTitles.js', 'js/export.js', 'js/dataGrid.js', 'js/dataGridFilters.js')); ?>
...
<?php TemplateUtility::printTabs($this->active); ?>
    <div id="main">
        ...
        <div id="contents"<?php echo !$this->dataGrid->getNumberOfRows() ? ' style="background-color: #E6EEFF; padding: 0px;"' : ''; ?>>
            ...
            <p class="note">
                <span style="float:left;">Listen  -
                    Seite <?php echo($this->dataGrid->getCurrentPageHTML()); ?> (<?php echo($this->dataGrid->getNumberOfRows()); ?> Einträge)
                </span>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="956">
                ...
                <td style="padding-left: 62px;" align="center" valign="center">
                    ...
                    Erstellen Sie Listen, um Kandidaten, Jobaufträge, Unternehmen und Kontakte zu gruppieren und schnell Aktionen auszuführen.
                    <br /><br />
                    <span style="font-size: 14px; font-weight: normal;">
                    Erstellen Sie Listen über die Reiter <b>Jobaufträge, Kandidaten, Unternehmen</b> oder <b>Kontakte</b>.
                    </span>
                    </div>
                </td>
